...
DROP TABLE IF EXISTS turbineRegistry CASCADE;
DROP TABLE IF EXISTS turbineTelemetry CASCADE;
...
-- ============================
-- turbineTelemetry TABLE
-- ============================
CREATE TABLE turbineRegistry (
